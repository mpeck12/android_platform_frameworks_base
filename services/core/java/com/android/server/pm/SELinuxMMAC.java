...
public final class SELinuxMMAC {
    ...
    // Append to existing seinfo labels when opting in for preventDownloadExecution attribute
    private static final String NOEXECUTE_STR = "_nx_file";
     ...
     * default seinfo label of 'default' its security label would be set to "default_nx_file".
     *
